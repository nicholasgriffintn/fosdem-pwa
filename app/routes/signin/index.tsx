				...
				<div className="flex flex-col gap-8">
					<div className="space-y-6">
						<p className="text-lg text-slate-200">
							Connect with your GitHub account to unlock personalized features that enhance your experience.
						</p>
						<div className="space-y-3">
							<h2 className="text-lg font-semibold text-slate-100">What you'll be able to do:</h2>
					...
					<div className="space-y-4">
						...
						<p className="text-sm text-slate-400 text-center max-w-md mx-auto">
							This will request read only access to your GitHub profile and email only.
							We will use this to create your account and to send notifications (if you want them).
						</p>
					</div>
				</div>
			</div>
